...
export function WeightedConfidenceDisplay({ confidence }: WeightedConfidenceDisplayProps) {
  ...
  const colorMap = {
    green: { bar: "bg-primary", text: "text-primary", glow: "shadow-[0_0_12px_rgba(124,58,237,0.3)]" },
    amber: { bar: "bg-amber",   text: "text-amber",   glow: "shadow-[0_0_12px_rgba(217,119,6,0.3)]" },
    red:   { bar: "bg-destructive", text: "text-destructive", glow: "shadow-[0_0_12px_rgba(220,38,38,0.3)]" },
  };
    ...
    <div className="bg-surface border border-border rounded-2xl overflow-hidden">
      ...
      {expanded && (
        <div className="border-t border-border px-6 py-5 space-y-4">
          {/* Derivation */}
          <div className="flex items-start gap-2 bg-[#F8FAFC] border border-border rounded-sm p-4">
