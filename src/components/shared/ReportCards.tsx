...
export function InterestCard({ interest }: InterestCardProps) {
  return (
    <div className="bg-[#F8FAFC] border border-border rounded-sm p-4 flex flex-col gap-3 hover:border-border-strong transition-colors">
...
export function PersonaCard({ persona, rank }: PersonaCardProps) {
  ...
  return (
    <div className="bg-[#F8FAFC] border border-border rounded-sm p-5 flex flex-col gap-4 hover:border-border-strong transition-colors">
...
export function ProblemCard({ problem }: ProblemCardProps) {
  return (
    <div className="bg-[#F8FAFC] border border-destructive/15 rounded-sm p-4 flex flex-col gap-2 hover:border-destructive/30 transition-colors">
      <div className="flex items-start justify-between gap-2">
