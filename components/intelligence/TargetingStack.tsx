...
export function TargetingStackDisplay({ stack }: TargetingStackDisplayProps) {
  return (
    <div className="space-y-4">
      ...
      {/* Reach estimate */}
      <div className="flex items-center justify-between bg-[#0B1120] border border-border rounded-sm px-4 py-3">
        <div>
      ...
      {/* Stack explanation */}
      <div className="bg-[#0B1120] border border-border rounded-sm px-4 py-3">
